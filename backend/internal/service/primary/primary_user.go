...
func (s *primaryService) GetUserProfileByID(ctx context.Context, id uint) (*service.UserProfile, error) {
...
func (s *primaryService) GetCurrentUserProfile(ctx context.Context, user *model.User) (*service.UserProfile, error) {
	// Map repository user to service user profile
	profile := service.ProfileFromUser(user, true)
	return &profile, nil
}

func (s *primaryService) UpdateCurrentUserProfile(
	ctx context.Context,
	user *model.User,
	newAvatarUrl,
	newBio *string,
